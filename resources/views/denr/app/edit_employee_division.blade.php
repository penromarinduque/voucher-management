                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default" style="padding-top: 12px;">
                        ...
                        <ul class="nav nav-tabs" style="font-size: 11px; text-transform: uppercase;">
                            ...
                            <li class="active" >
                                <a href="{!! url('pis/tbl_maintenance/viewdivision/'.Crypt::encrypt($record['id'])); !!}"><i class="fa fa-edit fa-fw"></i> View Employee Division</a>
                            </li>
                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                <div class="col-lg-12">
                                    ...
                                    {{Form::open(array('action'=>'denr\app\DivisionController@EditDivision'))}}
