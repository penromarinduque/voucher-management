                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default" style="padding-top: 12px;">
                        ...
                        <ul class="nav nav-tabs" style="font-size: 11px; text-transform: uppercase;">
                            ...
                            <li class="active" >
                                <a href="{!! url('pis/tbl_maintenance/viewposition/'.Crypt::encrypt($record['id'])); !!}"><i class="fa fa-edit fa-fw"></i> View Employee Position</a>
                            </li>
                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                <div class="col-lg-12">
                                    ...
                                    {{Form::open(array('action'=>'denr\app\PositionController@EditPosition'))}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;">
                                                        <select name="position_type" class="form-control" style="height: 33px; font-size: 12px; border-radius: 0px;">
                                                            ...
                                                            <option value="1" @if($record['position_type'] == '1') selected @endif > Officer In Charge </option>
                                                            <option value="2" @if($record['position_type'] == '2') selected @endif > Chief Officer </option>
                                                            <option value="3" @if($record['position_type'] == '3') selected @endif > Ordinary Employee </option>
                                                        <select>
                                                    </td>
                                                </tr>
                                                <tr>
