                    ...
                    <div class="panel panel-default" style="padding-top: 12px;">
                        ...
                        <ul class="nav nav-tabs" style="font-size: 11px; text-transform: uppercase;">
                            ...
                            <li style="margin-left: 12px;">
                                <a href="{{ route('employee.section.list') }}"><i class="fa fa-navicon fa-fw"></i> Employee Section</a>
                            </li>
                            
                            <li>
                                <a href="{{ route('employee.section.form') }}"><i class="fa fa-plus fa-fw"></i> Add New Section</a>
                            </li>

                            <li class="active" >
                                <a href="{!! url('denr/app/viewsection/'.Crypt::encrypt($record['id'])); !!}"><i class="fa fa-edit fa-fw"></i> View Employee Section</a>
                            </li>
                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                <div class="col-lg-12">
                                    ...
                                    {{Form::open(array('action'=>'denr\app\SectionController@EditSection'))}}
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <table class="table table-striped table-bordered table-hover tooltip-demo">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="3"><input type="text" name="section" value="{{ $record['section'] }}" class="form-control" style="height: 33px; font-size: 12px; border-radius: 0px; @if($errors->has('section')) border-color: #F08080;  box-shadow: none; @endif " placeholder="@if($errors->has('section'))Section is required @else Section @endif" data-toggle="tooltip" data-placement="left" title="Required" ></td>
                                                </tr>
                                                <tr>
                                                    <td style="width:150px; font-size: 11px; color: #5B5B5B; text-align: right; "><font style="color: #F00;">*</font> DIVISION</td>
                                                    <td style="padding: 0px;" colspan="3">
                                                        <select name="division" class="form-control" style="height: 33px; font-size: 12px; border-radius: 0px; @if($errors->has('division')) border-color: #F08080;  box-shadow: none; @endif " data-toggle="tooltip" data-placement="left" title="Required" >
