...
@section('page-content')
                    ...
                    <div class="panel panel-default" style="padding-top: 12px;">
                        ...
                        <ul class="nav nav-tabs" style="font-size: 11px; text-transform: uppercase;">
                            ...
                            <li class="active" style="margin-left: 12px;">
                                <a href="{{ route('user.access') }}"><i class="fa fa-navicon fa-fw"></i> User Access</a>
                            </li>
                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                <div class="col-lg-12">
                                    ...
                                    {{Form::open(array('action'=>'denr\app\UserAccessController@AddUserAccess'))}}
                                        ...
                                        @php $userlog = Auth::user(); @endphp
                                            ...
                                            <div class="panel panel-default" style="overflow: auto; height: 620px;">
                                                ...
                                                <table id="tblA" class="table table-striped table-bordered table-hover tooltip-demo">
                                                    ...
                                                    <tr>
                                                        <td colspan="11" style="width:150px; font-weight:100; font-size: 11px; color: #5B5B5B; padding: 10px; ">
                                                            <i class="fa fa-pencil-square fa-fw"></i> USER ACCESS FORM 
                                                    ...
                                                    <tr style="font-weight: bold; text-transform: uppercase;">
                                                        <td style="width:40px; font-size: 14px; color: #09C; text-align: center; vertical-align: middle; "><i class="fa fa-user"></i></td>
                                                        <td colspan="1" style="padding: 0px;">
                                                            <select name="user" id="user" onChange="completeFields('user', 'module')" class="form-control" style="height: 41px; width: 100%; float: left; color:#09C; font-size: 12px; text-transform: uppercase; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="@if($userlog->USER_LEVEL == '0') Super Admin  @elseif($userlog->USER_LEVEL == '1') Admin Users @elseif($userlog->USER_LEVEL == '2') Ordinary Users @endif">
                                                        ...
                                                        <td colspan="2" style="padding: 0px;">
                                                            <select name="module" id="module" class="form-control" style="height: 41px; color:#09C; font-size: 12px; text-transform: uppercase; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Modules">
                                                    ...
                                                    <tr style="font-weight: bold; text-transform: uppercase;">
                                                        ...
                                                        <td style="width:150px; font-size: 11px; color: #5B5B5B; text-align: left; ">Module</td>
            ...
            <script>
                ...
                function checkAll() {
                    ...
                    var checks = document.getElementsByName("view_access[]");
                    for (var i=0; i < checks.length; i++) {
                        checks[i].checked = true;
                    }
                    
                    var checks = document.getElementsByName("add_access[]");
                    for (var i=0; i < checks.length; i++) {
                        checks[i].checked = true;
                    }
                    
                    var checks = document.getElementsByName("edit_access[]");
                    for (var i=0; i < checks.length; i++) {
                        checks[i].checked = true;
                    }
                    
                    var checks = document.getElementsByName("delete_access[]");
                    for (var i=0; i < checks.length; i++) {
                        checks[i].checked = true;
                    }
                    
                    var checks = document.getElementsByName("print_access[]");
                    for (var i=0; i < checks.length; i++) {
                        checks[i].checked = true;
                    }
            ...
            @include('denr.app.scripts.ajaxUserAccess')
            @include('denr.app.scripts.ajaxUserModule')
