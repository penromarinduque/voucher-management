                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table table-striped table-bordered table-hover tooltip-demo">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:10%; font-size: 11px; color: #5B5B5B; text-transform: uppercase; font-weight: bold;">Doc. No.</td>
                                                ...
                                                <td style="width:12%; font-size: 11px; color: #5B5B5B; text-transform: uppercase; font-weight: bold;">To</td>
                                                <td style="width:12%; font-size: 11px; color: #5B5B5B; text-transform: uppercase; font-weight: bold;">Date Forwarded</td>
                                                <td style="width:18%; font-size: 11px; color: #5B5B5B; text-transform: uppercase;font-weight: bold;">Remarks</td>
                                                <td style="width:10%; font-size: 11px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: left;">Action</td>
                                            </tr>

                                            @if($doc_count > 0)

                                                @foreach($doc_forwarded as $id => $record)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 11px; color: #5B5B5B; text-align: left; padding: 0px; vertical-align: middle;" >
                                                            <a href='{{url("/dts/activity/incomingdocument/edit/".$code."/B")}}' class="btn btn-default" data-toggle="tooltip" data-placement="top" title="View" style="font-size: 12px; color: green; border-radius: 2px; width: 30%; "><i class="fa fa-edit"></i></a>
                                                            <a href="javascript:void(0)" class="btn-history btn btn-default" data-id="{{$record->DOC_NO}}" data-toggle="tooltip" data-placement="top" title="History Logs" style="font-size: 12px; color: #F00; border-radius: 2px; width: 30%;"><i class="fa fa-undo"></i></a>
                                                            <a href="javascript:void(0)" class="btn-attachment btn btn-default" data-id="{{$record->DOC_NO}}" data-id2="{{$record->SEND_TYPE}}" data-toggle="tooltip" data-placement="top" title="Forwarded Attchment" style="font-size: 12px; color: #000; border-radius: 2px; width: 30%;"><i class="fa fa-file-text-o"></i></a>
                                                        </td>
                                                    </tr>
