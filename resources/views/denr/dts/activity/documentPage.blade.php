                ...
                @if($doc_count > 0)
                    ...
                    @foreach($documents as $id => $record)
                        ...
                        <tr>
                            ...
                            <td style="font-size: 11px; color: #5B5B5B; text-align: left; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; " title="{{$record->DOC_SUBJ}}" data-toggle="tooltip" data-placement="left">{{$record->DOC_SUBJ}}</td>
