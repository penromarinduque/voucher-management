                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <table class="table table-striped table-bordered table-hover tooltip-demo">
                                                <tr>
                                                    <td colspan="6" style="width:150px; font-weight:100; font-size: 11px; color: #5B5B5B; padding: 10px; text-transform: uppercase; "><i class="fa fa-navicon fa-fw"></i> {{ $cat_desc }} LISTING <a href="javascript:void(0)" class="btn-filter" data-id="{{ $cat_desc }}" data-id2="{{ strtoupper($category) }}" style="float: right; "><i class="fa fa-search"></i> Filter</a></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-striped table-bordered table-hover tooltip-demo" style="table-layout: fixed;">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td style="width:12%; font-size: 11px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: left;">Remarks</td>
                                                        <td style="width:12%; font-size: 11px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: left;">Encoded By</td>
                                                        <td style="width:16%; font-size: 11px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: left;">Action</td>
                                                    </tr>
                                                </thead>
