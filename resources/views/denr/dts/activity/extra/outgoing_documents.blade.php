                                                        ...
                                                        @foreach($documents as $id => $record)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-size: 11px; color: #5B5B5B; text-align: center; padding: 0px; ">
                                                                    <div style="width: 20px; padding: 2px; margin:auto; margin-top: 5px; border-radius: 50px; color: #FFF; @if($record->STATUS == 'S') background-color: #00CD66; @elseif($record->STATUS == 'F') background-color: #33A1C9; @elseif($record->STATUS == 'R') background-color: #F00; @endif" data-toggle="tooltip" data-placement="left" title="@if($record->STATUS == 'S') Signed @elseif($record->STATUS == 'F') Forwarded @elseif($record->STATUS == 'R') Returned @endif">
                                                                        @if($record->STATUS == 'S') S @elseif($record->STATUS == 'F') F @elseif($record->STATUS == 'R') R @endif
                                                                    </div>
                                                                </td>
