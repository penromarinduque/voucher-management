...
@section('page-content')
                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <!-- DOC CAT -->    <select disabled class="form-control" name='doc_cat' id='doc_cat' style="height: 33px; font-size: 12px; text-transform: uppercase; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Documet Category">
                                                    ...
                                                    <td style="padding: 0px;">
                                    <!-- DOC TYPE -->   <select disabled class="form-control" name="doc_type" style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Documet Type" required>
                                    ...
                                    <!-- DOC NO -->     <input disabled id="doc_no" class="form-control" type="text" name='doc_no' value="{{ $documents['DOC_NO'] }}" style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Documet No." readonly="readonly" >
                                                    </td>
                                                    <td style="width:150px; font-size: 11px; color: #5B5B5B; text-align: right; "><font style="color: #F00;">*</font> CONTROL CODE :</td>
                                                    <td style="padding: 0px;">
                                    <!-- DOC NO -->    <input disabled id="control_code" class="form-control" type="text" value="{{ $documents['CONTROL_CODE'] }}" name='control_code' style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Control Code" >
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class='btn-panel-sender add_sender_rows_here'>
                                                    <td style="width:150px; font-size: 11px; color: #5B5B5B; text-align: right; text-transform: uppercase; "><font style="color: #F00;">*</font> Sender 1 :</td>
                                    ...
                                    <!-- SENDER-->      <select id="sender_type_2_input" class="form-control" name='doc_from[]' style="height: 33px; width: 100%; float: left; font-size: 12px; border-radius: 0px; @if($senders1['SENDER_TYPE'] == 'OUT') display:none; @endif" data-toggle="tooltip" data-placement="left" title="Sender" disabled>
                                                        ...
                                                        <input type="text" class="form-control" name="doc_from[]" id="sender_type_1_input" value="{{$senders1['DOC_SENDER']}}" placeholder="Input Outsider" style="height: 33px; width: 100%; float: left; font-size: 12px; border-radius: 0px; @if($senders1['SENDER_TYPE'] == 'IN') display:none; @endif" data-toggle="tooltip" data-placement="left" title="Sender" required  disabled>
                                                    ...
                                                    <td style="padding: 0px;">
                                    <!-- DOC DATE -->   <input disabled type="date" name='doc_date' value="{{ $documents['DOC_DATE'] }}" class="form-control" style="height: 33px; font-size: 12px; border-radius: 0px; width: 50%; float: left;" data-toggle="tooltip" data-placement="left" title="Documet Date" required>
                                    <!-- DOC TIME -->   <input disabled type="time" name='doc_time' value="{{ $documents['DOC_TIME'] }}" class="form-control" style="height: 33px; font-size: 12px; border-radius: 0px; width: 50%; float: left;" data-toggle="tooltip" data-placement="left" title="Documet Time" required>
                                                    </td>
                                                </tr>
                                                ...
                                                @foreach($senders2 as $id => $col)
                                                    ...
                                                    <tr class="btn-panel-sender">
                                                        <td style="width:150px; font-size: 11px; color: #5B5B5B; text-align: right; text-transform: uppercase; "><font style="color: #F00;">*</font> Sender {{$id+2}} :</td>
                                                        <td style="padding: 0px; ">
                                                            <select id="sender_type_2{{$id+1}}_input" class="form-control" name="doc_from[]" style="height: 33px; width: 100%; float: left; font-size: 12px; border-radius: 0px; @if($col->SENDER_TYPE == 'OUT') display:none; @endif" data-toggle="tooltip" data-placement="left" title="Sender" disabled>
                                                                <option value=""> Select Insider </option>
                                                                @foreach($addresee_list as $addresee_item)
                                                            ...
                                                            <input type="text" name="doc_from[]" class="form-control"  id="sender_type_1{{$id+1}}_input" value="{{$col->DOC_SENDER}}" placeholder="Input Outsider" style="height: 33px; width: 100%; float: left; font-size: 12px; border-radius: 0px; @if($col->SENDER_TYPE == 'IN') display:none; @endif" data-toggle="tooltip" data-placement="left" title="Sender" required disabled>
                                ...
                                <!-- ORG OFFICE -->    <input disabled class="form-control" name='doc_origin_office' type="text" value="{{ $documents['ORIGIN_OFFICE'] }}" style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Originating Office"  required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="4">
                                <!-- ADDRESS -->        <input disabled class="form-control" name='doc_address' type="text" value="{{ $documents['DOC_ADDRESS'] }}" style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Address"  required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="4">
                                <!-- SUBJECT -->        <input disabled class="form-control" name='doc_subject' type="text" value="{{ $documents['DOC_SUBJ'] }}" style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Subject"  required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;">
                                <!-- CLASSIFICATION --> <select disabled class="form-control" type="text" name='doc_classification' style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Classification">
                                                    ...
                                                    <td style="padding: 0px;">
                                <!-- URGENT -->         <select disabled class="form-control" type="text" name='doc_urgent' style="height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Urgent?">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="4">
                                <!-- REMARKS -->        <textarea disabled class="form-control" name='doc_remarks' style="height: 100px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Remarks">{{ $documents['REMARKS'] }}</textarea>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td colspan="4">
                                <!-- SUBMIT BUTTON -->  <a href="javascript:void(0)" class="btn-forward btn btn-sm btn-primary" data-id="{{$documents['DOC_NO']}}" style="height: 25px; width: 60px; padding: 2px 0px 0px 0px; "> Forward </a>
                                                        <a href="javascript:void(0)" class="btn-return btn btn-sm btn-danger" data-id="{{$documents['DOC_NO']}}" style="height: 25px; width: 60px; padding: 2px 0px 0px 0px;"> Return </a>
            ...
            @include('denr.dts.activity.returnModal')
