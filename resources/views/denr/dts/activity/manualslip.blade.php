                            ...
                            <div style="width:1000px; margin:auto; padding:20px; font-family: Times New Roman;">
                                ...
                                <table border="1" style="font-size: 16px; width: 100%; font-family: arial; margin-top: -10px;">
                                    ...
                                    <tr style="background-color:#EBEBEB;">
                                        ...
                                        <td style="width:25%; padding: 5px;vertical-align: middle; font-size: 12px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: center;">Action to be taken</td>
                                        <td style="width:42%; padding: 5px;vertical-align: middle; font-size: 12px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: center;">Remarks</td>
