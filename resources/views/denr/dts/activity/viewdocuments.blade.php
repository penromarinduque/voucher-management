...
@section('page-content')
                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                ...
                                <div class="col-lg-12">
                                                ...
                                                <td colspan="6" style="width:150px; font-weight:100; font-size: 11px; color: #5B5B5B; padding: 0px 0px 0px 10px; text-transform: uppercase;">
                                                    ...
                                                    @if($documents->STATUS != 'C')
                                                        ...
                                                        <!-- @if($for_end->ACTION_TO_BE_TAKEN == '12') -->
                                                            ...
                                                            <a href="javascript:void(0)" class="btn-sign btn btn-default" data-id="{{$documents->DOC_NO}}" data-id2="{{$documents->DOC_CATEGORY}}" data-toggle="tooltip" data-placement="top" title="Sign" style="font-size: 12px; color: #F00; border-radius: 2px; width: 37px; float: right; margin-left: 2px; "><i class="fa fa-pencil"></i> </a>
                                    ...
                                    <!-- DOC CAT -->    <select disabled class="form-control" name='doc_cat' id='doc_cat' style="background-color: #FFF; height: 33px; font-size: 12px; text-transform: uppercase; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Documet Category">
                                                    ...
                                                    <td style="width:35%; padding: 0px;">
                                    <!-- DOC TYPE -->   <select disabled class="form-control" name="doc_type" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Documet Type" required>
                                    ...
                                    <!-- DOC NO -->     <input disabled id="doc_no" class="form-control" type="text" name='doc_no' value="{{ $documents['DOC_NO'] }}" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Documet No." readonly="readonly" >
                                                    </td>
                                                    <td style="font-size: 11px; color: #5B5B5B; text-align: right; "><font style="color: #F00;">*</font> CONTROL CODE :</td>
                                                    <td style="padding: 0px;">
                                    <!-- DOC NO -->    <input disabled id="control_code" class="form-control" type="text" value="{{ $documents['CONTROL_CODE'] }}" name='control_code' style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Control Code" >
                                                    </td>
                                                </tr>
                                    ...
                                    <!-- SENDER-->      <select id="sender_type_2_input" class="form-control" name='doc_from[]' style="background-color: #FFF; height: 33px; width: 100%; float: left; font-size: 12px; border-radius: 0px; @if($senders1['SENDER_TYPE'] == 'OUT') display:none; @endif" data-toggle="tooltip" data-placement="left" title="Sender" disabled>
                                                    ...
                                                    <td style="padding: 0px;">
                                    <!-- DOC DATE -->   <input disabled type="date" name='doc_date' value="{{ $documents['DOC_DATE'] }}" class="form-control" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px; width: 50%; float: left;" data-toggle="tooltip" data-placement="left" title="Documet Date" required>
                                    <!-- DOC TIME -->   <input disabled type="time" name='doc_time' value="{{ $documents['DOC_TIME'] }}" class="form-control" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px; width: 50%; float: left;" data-toggle="tooltip" data-placement="left" title="Documet Time" required>
                                                    </td>
                                                </tr>
                                ...
                                <!-- ORG OFFICE -->    <input disabled class="form-control" name='doc_origin_office' type="text" value="{{ $documents['ORIGIN_OFFICE'] }}" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Originating Office"  required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="4">
                                <!-- ADDRESS -->        <input disabled class="form-control" name='doc_address' type="text" value="{{ $documents['DOC_ADDRESS'] }}" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Address"  required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="4">
                                <!-- SUBJECT -->        <input disabled class="form-control" name='doc_subject' type="text" value="{{ $documents['DOC_SUBJ'] }}" style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Subject"  required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;">
                                <!-- CLASSIFICATION --> <select disabled class="form-control" type="text" name='doc_classification' style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Classification">
                                                    ...
                                                    <td style="padding: 0px;">
                                <!-- URGENT -->         <select disabled class="form-control" type="text" name='doc_urgent' style="background-color: #FFF; height: 33px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Urgent?">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px;" colspan="4">
                                <!-- REMARKS -->        <textarea disabled class="form-control" name='doc_remarks' style="background-color: #FFF; height: 100px; font-size: 12px; border-radius: 0px;" data-toggle="tooltip" data-placement="left" title="Remarks">{{ $documents['REMARKS'] }}</textarea>
                                                    </td>
                                                </tr>
                                        ...
                                        <!-- <div class="panel panel-default">
                                            ...
                                            <table class="table table-striped table-bordered table-hover tooltip-demo">
                                                ...
                                                <tr style="background-color:#F0FFF0;">
                                                    <td style="width:15%; font-size: 11px; color: #5B5B5B; text-transform: uppercase; font-weight: bold; text-align: right;">No.</td>
                                                    <td style="width:24%; font-size: 11px; color: #5B5B5B; text-transform: uppercase; font-weight: bold; text-align: left;">Attachment</td>
                                                    <td style="width:54%; font-size: 11px; color: #5B5B5B; text-transform: uppercase;font-weight: bold; text-align: left;">Description</td>
                                                ...
                                                @foreach($attachments as $id => $col)
                                                    ...
                                                    <tr class="log-history">
                                                        <td style="text-align:right;padding:4px 7px 4px 7px;vertical-align:middle;font-size:12px;">{{$id+1}}.</td>
                                                        <td style="text-align:left;padding:4px 7px 4px 7px;vertical-align:middle;font-size:12px;">{{ $col['FILE_ATTACHMENT'] }}</td>
                                                        <td style="text-align:left;padding:4px 7px 4px 7px;vertical-align:middle;font-size:12px;">{{ $col['ATTACHMENT_DESC'] }}</td>
                                                        <td style="padding: 0px; text-align: left; vertical-align: middle;">
                                                            <a href="javascript:void(0)" class="btn-attachment btn btn-default" data-id="" data-toggle="tooltip" data-placement="top" title="Preview" style="font-size: 12px; color: #09C; border-radius: 2px; width: 50%; float: left; "><i class="fa fa-eye"></i></a>
                                                            <a href='{{url("/dts/activity/document/download/".$col->FILE_ATTACHMENT)}}' class="btn-download btn btn-default" data-id="" data-toggle="tooltip" data-placement="top" title="Download" style="font-size: 12px; color: green; border-radius: 2px; width: 50%; float: left; "><i class="fa fa-download"></i></a>
                                            ...
                                            <table class="table table-striped table-bordered table-hover tooltip-demo">
                                                ...
                                                @foreach($history_logs as $id => $col)
                                                    ...
                                                    <tr class="log-history">
                                                        ...
                                                        <td style="text-align:center;padding:4px 7px 4px 7px;vertical-align:middle;font-size:12px;">{{ date('m/d/Y', strtotime($col->SEEN_DATE_TIME)) }} <br/> {{ date('h:i A', strtotime($col->SEEN_DATE_TIME)) }}</td>
                                                        ...
                                                        <td style="padding: 0px; text-align: center; vertical-align: middle;">
                                                            ...
                                                            <!-- @if($col->DOC_TO == $user->id)
                                                                @if($col->SEEN == 'N')
                                                                    {{Form::open(array('action'=>'denr\dts\activity\DocumentTrackingController@SeenLog'))}}
                                                                        <input type="hidden" name="log_id" value="{{$col->ID}}">
                                                                        <button type="submit" class="btn btn-default" data-id="" data-toggle="tooltip" data-placement="top" title="Seen?" style="font-size: 12px; color: green; border-radius: 2px; width: 50%; float: left; "><i class="fa fa-check"></i></button>
                                                                    {{Form::close()}}
                                                                @endif
                                                            @endif -->

                                                            <!-- <a href="javascript:void(0)" class="btn-download btn btn-default" data-id="" data-toggle="tooltip" data-placement="top" title="Download Attachment" style="font-size: 12px; color: green; border-radius: 2px; width: 45%; "><i class="fa fa-download"></i></a> -->
                                                            <!-- <a href="javascript:void(0)" class="btn-remove btn btn-default" data-id="" data-toggle="tooltip" data-placement="top" title="Remove Attachment" style="font-size: 12px; color: #F00; border-radius: 2px; width: 30%; "><i class="fa fa-times"></i></a> -->
                                                        </td>
                                                    </tr>
            ...
            @include('denr.dts.activity.modal.signModal')
