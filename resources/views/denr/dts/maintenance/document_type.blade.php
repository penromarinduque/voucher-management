                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td style=" padding: 5px 20px 5px 20px; font-size: 12px; vertical-align: top;">{{$col['TYPE_NAME']}}</td>
                                        <td style="width: 150px; padding: 5px 20px 5px 20px; font-size: 12px; vertical-align: middle;">
                                            @php $code = Crypt::encrypt($col->ID) @endphp
                                            <a href="{{ url('dts/maintenance/documenttype/edit/'.$code) }}"><button style="width: 50px;" class="btn btn-outline btn-primary btn-xs">Edit</button></a>
                                            <a href="javascript:void(0)" class="btn-delete" data-id="{{ $col['ID'] }}" data-username="{{ $col['TYPE_NAME'] }}"><button style="width: 50px;" class="btn btn-outline btn-danger btn-xs">Delete</button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="modal-dialog" style="margin-top: 100px; width: 450px;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="padding: 30px 25px 30px 25px; text-align: center;">
                            ...
                            Are you sure you want to delete Document Type ( <b id="del_name"></b> ) ?
                                                           
                        </div>
                        <div class="modal-footer">

                            {{Form::open(array('action'=>'denr\dts\maintenance\DocumentTypeController@DeleteDocType'))}}
