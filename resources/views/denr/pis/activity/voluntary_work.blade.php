                                    ...
                                    {{Form::open(array('action'=>'denr\pis\activity\VoluntaryWorkController@AddVoluntaryWork'))}}
                                        ...
                                        <div class="panel panel-default" style="overflow: auto;">
                                            ...
                                            <table id="tbl1" class="table table-striped table-bordered table-hover tooltip-demo">
                                                <tr id="tr1">
                                                    <td style=" font-size: 11px; color: #5B5B5B; text-align: center; vertical-align:middle; font-weight: bold;" rowspan="2">NAME & ADDRESS OF ORGANIZATION</td>
                                                    ...
                                                    <td style=" font-size: 11px; color: #5B5B5B; text-align: center; vertical-align:middle; font-weight: bold;" rowspan="2">POSITION / NATURE OF WORK</td>
                                                ...
                                                @if($voluntary_count == 0)

                                                    <tr class="item-row" id="tr1">
                                                        <td style="padding: 0px;"><input type="text" name="name_address_org[]" value="" class="form-control" style="width: 370px; height: 33px; font-size: 12px; border-radius: 0px;" placeholder=""></td>
                                                        ...
                                                        <td style="padding: 0px;"><input type="text" name="number_hours[]" value="" class="form-control" style="width: 102px; height: 33px; font-size: 12px; border-radius: 0px;" placeholder=""></td>
                                                        <td style="padding: 0px;"><input type="text" name="position_nature[]" value="" class="form-control" style="width: 220px; height: 33px; font-size: 12px; border-radius: 0px;" placeholder=""></td>
                                                ...
                                                @elseif($voluntary_count > 0)                                                
                                                
                                                    @foreach($voluntary as $id => $col)
                                                    <tr class="item-row" id="tr1">
                                                        <input type="hidden" name="voluntary_id[]" value="{{ $col['id'] }}">
                                                        <td style="padding: 0px;"><input type="text" name="name_address_org2[]" value="{{ $col['name_address_org'] }}" class="form-control" style="width: 370px; height: 33px; font-size: 12px; border-radius: 0px;" placeholder=""></td>
                                                        ...
                                                        <td style="padding: 0px;"><input type="text" name="number_hours2[]" value="{{ $col['number_of_hours'] }}" class="form-control" style="width: 102px; height: 33px; font-size: 12px; border-radius: 0px;" placeholder=""></td>
                                                        <td style="padding: 0px;"><input type="text" name="position_nature2[]" value="{{ $col['position_nature_work'] }}" class="form-control" style="width: 220px; height: 33px; font-size: 12px; border-radius: 0px;" placeholder=""></td>
                                                        <td style="padding: 0px; vertical-align: middle; text-align: center;"><button onclick="deleteRow(this)" style="background-color:transparent; border:0px; color: #F00;"><i class="fa fa-times"></i></button></td>
                                                    </tr>
                                                    @endforeach
