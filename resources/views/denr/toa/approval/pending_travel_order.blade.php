                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX" @if($col['approval_status']!='2') style="background-color: #f2dede;" @endif>
                                        ...
                                        <td style="width: 200px; padding: 5px 20px 5px 20px; font-size: 12px; vertical-align: middle;">
                                            @php $code = Crypt::encrypt($col->id) @endphp
                                                ...
                                                @if($col['recommender'] == Auth::user()->id || Auth::user()->user_type == '1' || Auth::user()->user_type == '2')
                                                    @if($col['approval_status']=='0')
                                                    ...
                                                    @endif
                                                @endif
                                                @if($col['approver'] == Auth::user()->id || Auth::user()->user_type == '1' || Auth::user()->user_type == '2')
                                                    @if($col['approval_status']=='1')
                                                    <a style="cursor:pointer;" onClick=MM_openBrWindow("{{ url('toa/approval/pendingtravelorder/edit/'.$code) }}",'')><button style="width: 85px;" class="btn btn-outline btn-success btn-xs">Travel Orde</button></a>
                                                    @endif
                                                @endif
