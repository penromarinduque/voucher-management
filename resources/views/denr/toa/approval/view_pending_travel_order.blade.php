                        ...
                        <div class="panel-body">
                            <div class="row"> 
                                ...
                                @php $user = Auth::user(); @endphp
                                        ...
                                        @if($user->user_type == '1' || $user->user_type == '2' || $order['approver'] == $user->id )

                                            @if($order['approval_status'] == '1')

                                            <a href="javascript:void(0)" class="btn-approve" data-id="" id="gen_link"><button type="button" class="btn btn-success btn-xs" style="height: 25px; width:90px; font-size: 11px; float: right; margin-right: 10px;" data-toggle="tooltip" data-placement="right" title="Approve Travel Order"><i class="fa fa-check"></i> APPROVE</button></a>
                                            <!-- <a href="{!! url('pis/approval_manager/viewpendingtravelorder/'.Crypt::encrypt($order['id'])).'#approve'; !!}" id="gen_link"><input type='button' value='Approve' style='width:70px; height:25px; margin-top:35px; float:right; margin-right:10px; font-size:13px; color:green;'/></a>-->
                                            @endif

                                        @endif

                                        @if($user->user_type == '1' || $user->user_type == '2' || $order['recommender'] == $user->id )

                                            @if($order['approval_status'] == '0')

                                            <a href="javascript:void(0)" class="btn-recommend" data-id="" id="gen_link"><button type="button" class="btn btn-primary btn-xs" style="height: 25px; width:100px; font-size: 11px; float: right; margin-right: 10px;" data-toggle="tooltip" data-placement="right" title="Recommend Travel Order"><i class="fa fa-check"></i> RECOMMEND</button></a>
                                            <!-- <a href="{!! url('pis/approval_manager/viewpendingtravelorder/'.Crypt::encrypt($order['id'])).'#recommend'; !!}" id="gen_link"><input type='button' value='Recommend' style='width:90px; height:25px; margin-top:35px; float:right; margin-right:10px; font-size:13px; color:green;'/></a> -->
                                            @endif
                                        @endif
                                        ...
                                        <div style="width:1000px; margin:auto; padding:20px; font-family: Times New Roman;">
                                            ...
                                            <table style="line-height: 30px; font-size: 20px; margin-left: 110px; width: 780px;">
                                                <tr>
                                ...
                                <div class="modal-dialog" style="margin-top: 100px; width: 450px;">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" style="color: green;"><i class="fa fa-check-circle"></i> Approval Confirmation</h4>
                                        </div>
                                        <div class="modal-body" style="padding: 30px 25px 30px 25px; text-align: center;">
                                        
                                                Are you sure you want to approve Travel Order ( <b>{{ $order['order_no'] }}</b> ) ?
                                           
                                        </div>
                                        <div class="modal-footer">

                                                {{Form::open(array('action'=>'denr\toa\approval\PendingTravelOrderController@ApprovePendingTravelOrder'))}}
                                                    ...
                                                    <input type='submit' name='approve' value='Yes' class='btn btn-success' style='width:50px; height:30px; padding:2px 2px 2px 2px; float:right;'/>
                            ...
                            <div id="recommendModal" class="modal fade" role="dialog">
                                <div class="modal-dialog" style="margin-top: 100px; width: 450px;">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title" style="color: #09C;"><i class="fa fa-check-circle"></i> Recommend Confirmation</h4>
                                        </div>
                                        <div class="modal-body" style="padding: 30px 25px 30px 25px; text-align: center;">
                                        
                                                Are you sure you want to recommend Travel Order ( <b>{{ $order['order_no'] }}</b> ) ?
                                           
                                        </div>
                                        <div class="modal-footer">

                                                {{Form::open(array('action'=>'denr\toa\approval\PendingTravelOrderController@RecommendPendingTravelOrder'))}}
                            
                                                    <input type="hidden" name="order_id" value="{{ $order['id'] }}" />
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal" style='width:50px; height:30px; padding:2px 2px 2px 2px; float:right; margin-left:10px;'>No</button>
                                                    <input type='submit' name='recommend' value='Yes' class='btn btn-success' style='width:50px; height:30px; padding:2px 2px 2px 2px; float:right;'/>
